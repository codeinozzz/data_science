...
from config.settings import (
    N_CLUSTERS, CLUSTERING_METHOD, REDUCTION_METHOD,
    PROCESSED_DIR, MODELS_DIR, CHROMA_DB_DIR
)
...
def main():
    ...
    # Paso 1: Cargar embeddings de ChromaDB
    ...
    # Paso 4: Analizar composición de clusters
